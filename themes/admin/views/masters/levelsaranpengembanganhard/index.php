...
<?php $this->widget('ext.cdatatables.cdatatables',array(
			...
			'options'=>array(
					'bProcessing'=> true,
					'bServerSide'=> true,
					'sAjaxSource' => Yii::app()->createUrl('/masters/levelsaranpengembanganhard/loadprocessing'),
					'aoColumns'=> array(
							array(  "mDataProp"=> "id",
                      "sName"=> "id",
                      "bSearchable"=> false,
              ...
              array(  "mDataProp"=> "nama_saran",
                ...
                "sName"=> "ids",
								...
								return '<span class=\"button-group\">'+
										'<a href=\"".Yii::app()->createUrl('masters/levelsaranpengembanganhard/update/id/')."/'+oObj.aData['ids']+'\" class=\"button icon edit\">Edit</a>'+
