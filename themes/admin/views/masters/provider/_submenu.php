<div class="speedbar">
    <div class="speedbar-content">
        ...
        <a href="<?php echo Yii::app()->createUrl('masters/provider')?>" class="button icon home">Provider</a>
				<a href="<?php echo Yii::app()->createUrl($this->module->id.'/provider/create')?>" class="button icon add">Tambah</a>
