...
<?php $this->widget('ext.cdatatables.cdatatables',array(
			...
			'options'=>array(
              ...
              array(  "mDataProp"=> "nama_asesor",
                    ...
                    '<a href=\"#\" pid=\"'+oObj.aData[0]+'\" class=\"button icon danger pilihasessor\">Pilih Asesor</a>'+
                    ". ( Yii::app()->user->getIsSuperAdmin() ? 
                    "'<a href=\"".Yii::app()->createUrl('masters/pesertaasesor/penilaian/id')."/' + oObj.aData['id'] + '\" class=\"button icon\">SOFT</a><a href=\"".Yii::app()->createUrl('masters/pesertaasesor/penilaianhard/id')."/' + oObj.aData['id'] + '\" class=\"button icon\">HARD</a>'+" : "").
										"'</span>';
