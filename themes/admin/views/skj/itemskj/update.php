...
<div class="header-page">
	<div style="float:left;vertical-align: middle;">
		<h2 class="textTitle">Update Item SKJ pada <a href="<?php echo Yii::app()->createUrl('skj/itemskj/index/id/'.$model->skj_id)?>"><?php echo $model->skj->skj_name;?></a> : (<?php echo $model->skj->getSKJType()?>)</h2>
	</div>
...
<?php echo $this->renderPartial('_form', array('model'=>$model,'params'=>$params,'itemkompetensi'=>$itemkompetensi)); ?>
<div style="clear: both"></div>
</div>