...
<div class="speedbar">
    <div class="speedbar-content">
		<span class="button-group">
			  <a href="<?php echo Yii::app()->createUrl('masters/'.$this->id.'/create')?>" <?php echo ( $here == 'create') ? 'class = "button icon act_link"':'class = "button icon act_link"' ?>>Tambah</a>
        <a href="<?php echo Yii::app()->createUrl('masters/'.$this->id)?>" <?php echo ( $here == 'index') ? 'class = "button icon act_link"':'class = "button icon act_link"' ?>>Daftar</a>
