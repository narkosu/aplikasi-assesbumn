    ...
    <div class="speedbar-content">
		...
		<Div style="float:left;">
			...
			<span class="button-group">
				<a href="<?php echo Yii::app()->createUrl($this->module->id.'/departement')?>" class="button icon home">Department</a>
				<a href="<?php echo Yii::app()->createUrl($this->module->id.'/departement/create')?>" class="button icon add">Tambah</a>
				<a href="<?php echo Yii::app()->createUrl($this->module->id.'/departement')?>" class="button icon log">Daftar</a>
			</span>
			<?php /*
