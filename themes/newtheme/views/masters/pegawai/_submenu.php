<div class="speedbar">
    <div class="speedbar-content">
        ...
        <a href="<?php echo Yii::app()->createUrl('masters/pegawai')?>" class="button icon home">Pegawai</a>
				<a href="<?php echo Yii::app()->createUrl($this->module->id.'/pegawai/create')?>" class="button icon add">Tambah</a>
