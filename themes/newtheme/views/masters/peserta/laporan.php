...
<?php $this->widget('ext.cdatatables.cdatatables',array(
            ...
            array(
                ...
                "sName"=> "NUMBER",
                      ...
                      return '<SPAN>' + oObj.aData['id'] + '</SPAN>';
                    }"
                ),
...
<div style="width:100%">
	...
	<thead style="font-size:12px;">
		<tr>
			...
			<th style="text-align:center;width:70px;">Nip</th>
			<th >Nama</th>
			<th style="text-align:center;width:70px;">Tahun Penilaian</th>
			<th style="text-align:center;width:70px;">Pemenuhan Kompetensi (%)</th>
			<th style="text-align:center;width:200px;">Rekomendasi</th>
		</tr>
	</thead>
