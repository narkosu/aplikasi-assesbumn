 ...
 */
class LevelSaranpengembangan extends CActiveRecord
{
	/**
	...
	{
		return '{{level_saranpengembangan}}';
	}
	...
	public function rules()
	{
		...
		return array(
			array('departemen_id, kompetensi_id, jenispengembangan_id, keterangan', 'required'),
	...
	public function relations()
	{
		...
		return array(
        'detail'=>array(self::HAS_MANY, 'LevelSaranpengembanganDetail', 'id_saranpengembangan'),
		);
	}
  ...
  public function detail($deptId,$kompId,$jenpengId,$level){
    ...
    return $this->find('departemen_id = :depid And 
