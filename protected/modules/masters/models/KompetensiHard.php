 ...
 */
class KompetensiHard extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('departement_id, skj_id,jeniskompetensi_id, name', 'required'),
	...
	public function relations()
	{
		...
		return array(
			...
			'jenkom'=>array(self::BELONGS_TO,'JeniskompetensiHard','jeniskompetensi_id'),
			'jenisKompetensi'=>array(self::BELONGS_TO,'JeniskompetensiHard','jeniskompetensi_id')
		);
	}
