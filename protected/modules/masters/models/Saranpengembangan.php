...
class Saranpengembangan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, departemen_id, kompetensi_id, jenispengembangan_id, level', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
      ...
      'kompetensi'=>array(self::BELONGS_TO,'Kompetensi','kompetensi_id'),
  ...
  public function getsaranpengembangan($depid,$komp_id,$jenis){
		
		$r = $this->find('departemen_id = :deptid and kompetensi_id = :kid and jenispengembangan_id = :jkid '
                        ,array(':deptid'=>$depid,':kid'=>$komp_id,':jkid'=>$jenis));
		return $return;
	}
}