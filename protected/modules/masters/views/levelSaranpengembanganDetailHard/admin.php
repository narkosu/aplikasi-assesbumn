...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('level-saranpengembangan-detail-hard-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Level Saranpengembangan Detail Hards</h1>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'level-saranpengembangan-detail-hard-grid',
